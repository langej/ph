...
test('test *if attribute', async ({ page }) => {
    await page.setContent(
        createContent(/*html*/ `
            <ph-component tag="test-div">
                <template>
                    ...
                    <div *if="flag"  id="not-present">Present</div>
                    <div *if="!flag" id="present">Not Present</div>
                    <script on-mount>
                        setTimeout(() => {
                            flag = true
                        }, 100)
...
test('test *show attribute', async ({ page }) => {
    await page.setContent(
        createContent(/*html*/ `
            <ph-component tag="test-div">
                <template>
                    ...
                    <div *show="flag" id="present">Present</div>
                    <div *show="!flag" id="not-present">Not Present</div>
                    <script on-mount>
                        setTimeout(() => {
                            flag = true
                        }, 100)
